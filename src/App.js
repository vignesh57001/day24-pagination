...
function App() {
  ...
  const data = [
    ...
    },
    {
      "id": "10",
      "name": "Marvin Fay",
      "email": "Osbaldo108@hotmail.com"
    },
    {
      "id": "11",
      "name": "Torrance Rau",
      "email": "Orin410@gmail.com"
    },
    {
      "id": "12",
    ...
    },
    {
      ...
      "email": "Antwan.Schoen110@yahoo.com"
    },
    {
      "id": "18",
      "name": "Delmer Marvin",
    ...
    },
    {
      ...
      "email": "Lonnie.Greenfelder910@hotmail.com"
    },
    {
      "id": "47",
      "name": "Gilda Huel",
    ...
    },
    {
      "id": "51",
      "name": "Ora Kilback",
      "email": "Matt210@gmail.com"
    },
    {
      "id": "52",
      "name": "Lera Macejkovic",
      "email": "Jamal.Donnelly410@hotmail.com"
    },
    {
      "id": "53",
      "name": "Asa Gottlieb",
    ...
    },
    {
      "id": "78",
      "name": "Hailie Haag",
      "email": "Edythe.Lind109@hotmail.com"
    },
    {
      "id": "79",
    ...
    },
    {
      "id": "98",
      "name": "Madge Bogisich",
      "email": "Joey.Marquardt100@gmail.com"
    },
    {
      "id": "99",
  ...
  let next = () => {
    if (currentPage !== (data.length / 10) - 1) {
        ...
        <div className="col-lg-12">
          ...
          <nav aria-label="Page navigation example">
            <ul className="pagination">
              ...
              {
                [...Array(data.length / 10)].map((page, index) => {
                  return (
                    <li className="page-item"><button className={`page-link ${currentPage === (index) ? 'active' : ''}`} onClick={() => paginate(index)}>{index + 1}</button></li>
                  )
                })
              }
